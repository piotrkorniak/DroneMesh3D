...
Serwis klienta HTTP z inject() (Angular 21).
...
export class AreaService {
  ...
  createArea(geojson: CreateAreaRequest): Observable<CreateAreaResponse> {
    return this.http.post<CreateAreaResponse>(this.apiUrl, geojson);
  }
}
```
